    ...
    variants: {
      variant: {
        ...
        success: [
          ...
          "dark:border-emerald-500/30 dark:bg-emerald-900/90 dark:text-emerald-200",
          "backdrop-blur-sm",
        ],
        destructive: [
        ...
        info: [
          "border-blue-500/20 bg-blue-50/90 text-blue-800",
          "dark:border-blue-500/30 dark:bg-blue-900/90 dark:text-blue-200",
          "backdrop-blur-sm",
        ],
        warning: [
          "border-amber-500/20 bg-amber-50/90 text-amber-800",
          "dark:border-amber-500/30 dark:bg-amber-900/90 dark:text-amber-200",
          "backdrop-blur-sm",
        ],
      },
    },
